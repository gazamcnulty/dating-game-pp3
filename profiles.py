...
def profile_function():
    ...
    {match_1["date_name"]}'s likes can be described as follows -{match_1["likes"]}

    {match_1["date_name"]}'s favourite food type is {match_1["food_preference"]}

    {match_1["date_name"]}'s favourite drink type is {match_1["drink_preference"]}
    ...
    {match_2["date_name"]}'s likes can be described as follows -{match_2["likes"]}

    {match_2["date_name"]}'s favourite food type is {match_2["food_preference"]}

    {match_2["date_name"]}'s favourite drink type is {match_2["drink_preference"]}
    ...
    {match_3["date_name"]}'s likes can be described as follows -{match_3["likes"]}

    {match_3["date_name"]}'s favourite food type is {match_3["food_preference"]}

    {match_3["date_name"]}'s favourite drink type is {match_3["drink_preference"]}
